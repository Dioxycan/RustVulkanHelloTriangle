...
use crate::swapchain::{query_swap_chain_support, SwapChainSupportDetails};
...
fn is_device_suitable(
    ...
    let physical_device_features =
        ...
        if check_device_suitable(instance, physical_device) &&find_queue_families(instance, &physical_device, surface).is_complete(){
